        ...
        nodes: [
            {
                ...
                x: 100,
                y: 100,
                icon: {text: '\uf1d7', font: 'normal 45px FontAwesome', color: '250,250,250', left: -22, top: 15},
                textPosition: 'Bottom_Center',
                fontColor: '10,10,10',
                textOffsetY: 5,
                borderColor: '220,220,250'
            },
            {
                label: '网址\nwww.graphvis.cn',
                shape: 'circle',
                x: 300,
                y: 100,
                icon: {text: '\uf26b', font: 'normal 45px FontAwesome', color: '120,120,220', left: -22, top: 15},
                textPosition: 'Bottom_Center',
                fontColor: '10,10,10',
                textOffsetY: 5,
                color: '240,240,240',
                fontColor: '120,120,240',
                borderColor: '220,220,250'
            },
            {
                label: ' GraphVis 图说数据 ',
                ...
                x: 500,
                y: 100,
                icon: {text: '\uf1d1', font: 'normal 45px FontAwesome', color: '250,255,255', left: -22, top: 15},
                color: '10,210,255',
                fontColor: '50,50,50',
                labelBackGround: '225,225,245',
                labelBorderWidth: 2,
                labelBorderColor: '250,250,250',
                textOffsetY: 18,
                textPosition: 'Bottom_Center'
            },
            {
                ...
                x: 100,
                y: 300,
                icon: {text: '\uf2bb', font: 'bold 40px FontAwesome', color: '250,250,240', left: -160, top: -10},
                width: 360,
                height: 120,
            ...
            },
            {
                ...
                x: 100,
                y: 500,
                icon: {text: '\uf02d', font: '40px FontAwesome', color: '180,200,180', left: 200, top: 90},
                width: 500,
                height: 220,
                color: '250,50,50',
                textOffsetY: -60
            },
            {
                ...
                labelBorderWidth: 1,
                labelBackGround: '255,255,255',
                labelBorderColor: '250,50,50',
                textOffsetY: -12
            }],
        links: []
    };
